        ...
        <div>
          ...
          <input
            ...
            onChange={({ target: { value } }) =>
              setAPlayerResult({ ...aPlayerResult, home: parseInt(value, 10) })
            }
          />
        </div>
        <div>
          ...
          <input
            ...
            onChange={({ target: { value } }) =>
              setAPlayerResult({ ...aPlayerResult, away: parseInt(value, 10) })
            }
          />
        </div>
        <div>
      ...
      <div style={{ marginTop: 20, display: 'flex', flexDirection: 'column' }}>
        ...
        <div>
          ...
          <input
            ...
            onChange={({ target: { value } }) =>
              setBPlayerResult({ ...bPlayerResult, home: parseInt(value, 10) })
            }
          />
        </div>
        <div>
          ...
          <input
            ...
            onChange={({ target: { value } }) =>
              setBPlayerResult({ ...bPlayerResult, away: parseInt(value, 10) })
            }
          />
        </div>
        <div>
      ...
      <div style={{ marginTop: 20, display: 'flex', flexDirection: 'column' }}>
        ...
        <div>
          ...
          <input
            ...
            onChange={({ target: { value } }) =>
              setFinalResult({ ...finalResult, home: parseInt(value, 10) })
            }
          />
        </div>
        <div>
          ...
          <input
            ...
            onChange={({ target: { value } }) =>
              setFinalResult({ ...finalResult, away: parseInt(value, 10) })
            }
          />
        </div>
        <div>
